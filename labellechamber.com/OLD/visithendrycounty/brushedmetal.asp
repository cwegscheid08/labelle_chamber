...
<% On Error Resume Next
 ...
 '
   ...
   '   
   Private Const CC_FB_ToEmail = "info@visithendrycounty.com"
   '
   ...
   '
   Private Const CC_FB_AutoReply = true
   '
   ' The subject of the message to be sent to the user.
   '  
   Private Const CC_FB_AutoReplySubject = "Thank You!"
   '
   ...
   '  
   Private Const CC_FB_ResultsRedirect = "http://www.visithendrycounty.com"
   ...
   ' emails.
   '
   Private Const CC_FB_SMTPAddress = "relay-hosting.secureserver.net"
   '
   ...
   ' emails.
   '
   Private Const CC_FB_SMTPUsername = "steve@caloosadesign.com"
   '
   ' The password for the SMTP Server used for sending
   ' emails.
   '
   Private Const CC_FB_SMTPPassword = "Deetye375"
   ...
   '
   Private Const CC_FB_AcceptableFileTypes = "txt|gif|jpg|jpeg|zip|doc|png|pdf|rtf"
   '
     ...
     ' Make sure the mail is unicode for internationality.          
      ...
      If Request.Form("eM") <> "" Then
         ...
         If CC_FB_AutoReply Then
            ...
            formUserResponse = parseMessage("Thank you for e-mailing us.  We will reply as soon as possible." & VbCrLf & "", preferences)
